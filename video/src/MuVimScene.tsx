    ...
    >
      ...
      {[
        ...
        const msgOpacity = interpolate(
          frame,
          [msg.inFrame, msg.inFrame + 20, msg.outFrame, msg.outFrame + 20],
          [0, 1, 1, 0],
          { extrapolateLeft: "clamp", extrapolateRight: "clamp" },
        );
        const msgFloat =
          Math.sin(frame * msg.floatFreq * 0.017 + i * 2) * msg.floatAmp;
        ...
        return (
          <div
            ...
            style={{
              ...
              top: msg.top,
              opacity: msgOpacity,
              transform: `translateY(${msgFloat}px)`,
              pointerEvents: "none",
              maxWidth: 260,
            }}
          >
